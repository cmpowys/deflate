...
pub const BitStreamMiddleAged = struct {
    const Self = @This();
    ...
    pub fn fromBytes(bytes: []u8) BitStreamMiddleAged {
        return BitStreamMiddleAged{ .bytes = bytes, .bitPosition = 0, .currentByte = null };
    }
